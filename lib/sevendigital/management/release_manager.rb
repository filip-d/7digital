...
module Sevendigital
  ...
  class ReleaseManager < Manager
    ...
    def get_details(release_id, options = {})
      api_response = @api_client.make_api_request("release/details", {:releaseId => release_id}, options)
      @api_client.release_digestor.from_xml(api_response.content.release)
    end

    def get_tracks(release_id, options = {})
      options[:page_size] ||= 100
      api_response = @api_client.make_api_request("release/tracks", {:releaseId => release_id}, options)
      @api_client.track_digestor.list_from_xml(api_response.content.tracks)
    end

    def get_chart(options={})
      api_response = @api_client.make_api_request("release/chart", {}, options)
    ...
    def get_by_date(from_date = nil, to_date = nil, options = {})
      ...
      api_response = @api_client.make_api_request("release/byDate", parameters, options)
      @api_client.release_digestor.list_from_xml(api_response.content.releases)
    end

    def get_recommendations(release_id, options = {})
      api_response = @api_client.make_api_request("release/recommend", {:releaseId => release_id}, options)
    ...
    def get_top_by_tag(tags, options = {})
      api_response = @api_client.make_api_request("release/byTag/top", {:tags => tags}, options)
      @api_client.release_digestor.nested_list_from_xml( \
      api_response.content.tagged_results, :tagged_item, :tagged_results )
    end

    def search(query, options={})
      api_response = @api_client.make_api_request("release/search", {:q => query}, options)
