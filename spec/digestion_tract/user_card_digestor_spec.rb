...
describe "UserCardDigestor" do
  ...
  before do
     @card_digestor = Sevendigital::CardDigestor.new(nil)
  end
...
XML
    ...
    card.last4digits.should == "1234"

  end

  it "should parse from xml and populate all properties" do

    xml_response = load_sample_object_xml("user_card")

    user = @card_digestor.from_xml(xml_response)
    card.type.should == "MasterCard"
    card.last_4_digits.should == "1234"
    card.expiry_date.should == "1234"
    card.card_holder_name.should == "1234"
